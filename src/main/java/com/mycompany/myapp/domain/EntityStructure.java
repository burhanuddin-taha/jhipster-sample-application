...
public class EntityStructure implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties("entityStructures")
    private Entities belongTo;
    ...
    public Entities getBelongTo() {
        return belongTo;
    }

    public EntityStructure belongTo(Entities entities) {
        this.belongTo = entities;
        return this;
    }

    public void setBelongTo(Entities entities) {
        this.belongTo = entities;
    }
