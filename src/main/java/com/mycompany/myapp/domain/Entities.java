...
public class Entities implements Serializable {
    ...
    @OneToMany(mappedBy = "entityId")
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<EntityStructure> structures = new HashSet<>();
    ...
    public Set<EntityStructure> getStructures() {
        return structures;
    }

    public Entities structures(Set<EntityStructure> entityStructures) {
        this.structures = entityStructures;
        return this;
    }

    public Entities addStructure(EntityStructure entityStructure) {
        this.structures.add(entityStructure);
        entityStructure.setEntityId(this);
        return this;
    }

    public Entities removeStructure(EntityStructure entityStructure) {
        this.structures.remove(entityStructure);
        entityStructure.setEntityId(null);
        return this;
    }

    public void setStructures(Set<EntityStructure> entityStructures) {
        this.structures = entityStructures;
    }
