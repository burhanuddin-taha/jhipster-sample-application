...
public class EntitiesResourceIT {
    ...
    private static final String DEFAULT_BUSINESS_STRING = "AAAAAAAAAA";
    private static final String UPDATED_BUSINESS_STRING = "BBBBBBBBBB";
    ...
    public static Entities createEntity(EntityManager em) {
        Entities entities = new Entities()
            ...
            .businessString(DEFAULT_BUSINESS_STRING)
    ...
    public static Entities createUpdatedEntity(EntityManager em) {
        Entities entities = new Entities()
            ...
            .businessString(UPDATED_BUSINESS_STRING)
    ...
    public void createEntities() throws Exception {
        ...
        assertThat(testEntities.getBusinessString()).isEqualTo(DEFAULT_BUSINESS_STRING);
    ...
    public void getAllEntities() throws Exception {
        ...
        restEntitiesMockMvc.perform(get("/api/entities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].businessString").value(hasItem(DEFAULT_BUSINESS_STRING)))
    ...
    public void getEntities() throws Exception {
        ...
        restEntitiesMockMvc.perform(get("/api/entities/{id}", entities.getId()))
            ...
            .andExpect(jsonPath("$.businessString").value(DEFAULT_BUSINESS_STRING))
    ...
    public void updateEntities() throws Exception {
        ...
        assertThat(testEntities.getBusinessString()).isEqualTo(UPDATED_BUSINESS_STRING);
