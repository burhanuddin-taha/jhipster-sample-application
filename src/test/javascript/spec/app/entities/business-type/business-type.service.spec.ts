...
describe('Service Tests', () => {
  describe('BusinessType Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new BusinessType(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a BusinessType', () => {
      ...
      it('should update a BusinessType', () => {
        const returnedFromService = Object.assign(
          {
            type: 'BBBBBB'
          },
      ...
      it('should return a list of BusinessType', () => {
        const returnedFromService = Object.assign(
          {
            type: 'BBBBBB'
          },
      ...
      it('should delete a BusinessType', () => {
