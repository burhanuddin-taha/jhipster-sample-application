...
export class EntitiesUpdatePage {
  ...
  businessStringInput = element(by.id('field_businessString'));
  ...
  async setBusinessStringInput(businessString) {
    await this.businessStringInput.sendKeys(businessString);
  }

  async getBusinessStringInput() {
    return await this.businessStringInput.getAttribute('value');
  }
