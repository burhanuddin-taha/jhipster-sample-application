...
describe('Entities e2e test', () => {
  ...
  it('should create and save Entities', async () => {
    ...
    await promise.all([
      ...
      entitiesUpdatePage.setBusinessInput('business'),
    ...
    expect(await entitiesUpdatePage.getBusinessInput()).to.eq('business', 'Expected Business value to be equals to business');
